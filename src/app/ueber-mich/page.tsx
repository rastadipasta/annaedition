...
export default async function AboutPage() {
  ...
  return (
    <section className="section container about-grid about-page">
      <div className="about-visual" data-motion="load" data-motion-variant="image"><p className="eyebrow">{page?.eyebrow || "Über mich"}</p><div className="about-portrait"><Image className="about-portrait-image about-page-portrait-image" src="/images/anna-portrait.jpg" alt="Anna Matkovic bei der Arbeit am Laptop" fill priority sizes="(max-width: 800px) 100vw, 42vw" /></div><p className="script" style={{ fontSize: "2rem", color: "var(--wine)", textAlign: "right" }}>Anna</p></div>
