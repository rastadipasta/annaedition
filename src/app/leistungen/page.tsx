  ...
  return (
    <>
      ...
      <section className="container">
        ...
        <aside className="extras-card" data-motion="reveal"><p className="eyebrow">Extras</p><p><strong>Lichtideen & Beleuchtungskonzept</strong> · 15 € / m² &nbsp;&nbsp; <strong>Detaillierte Shoppingliste mit Direktlinks</strong> · 25 € / m²</p><small>Bei jedem Paket sind bis zu drei Anpassungsrunden enthalten. Weitere Änderungen oder zusätzliche 3D-Ansichten können flexibel hinzugebucht werden.</small></aside>
      </section>
      <section className="section callout"><div className="container callout-grid"><div data-motion="reveal"><p className="eyebrow" style={{ color: "#ae895d" }}>Schnelle Hilfe vom Profi</p><h2 className="display">Call a<br /><span style={{ color: "#ae895d" }}>Designer.</span></h2><p className="lede" style={{ color: "#f2e8e3" }}>90 Minuten persönliche Online-Beratung, konkrete Empfehlungen und eine maßgeschneiderte Shoppingliste.</p><p className="display" style={{ fontSize: "2.2rem", color: "#ae895d" }}>500 € inkl. MwSt.</p><Link className="button-link" style={{ color: "#ae895d" }} href="/kontakt?anfrage=call">Jetzt Beratung anfragen <ArrowRight size={16} /></Link></div><div className="callout-card" data-motion="reveal" data-motion-order="1"><p>Du brauchst keine komplette Raumplanung, sondern schnelle Klarheit, eine professionelle Zweitmeinung oder kreative Ideen für ein einzelnes Zimmer? Dieses Format ist direkt, fokussiert und unabhängig von deinem Wohnort.</p></div></div></section>
      <section className="section container"><header className="section-heading" data-motion="reveal"><p className="eyebrow">Unsere Bausteine</p><h2 className="display">Im <span className="accent">Detail.</span></h2></header><div data-motion="reveal"><ServicesAccordion services={services} /></div></section>
    </>
  );
}
