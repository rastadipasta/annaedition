...
export default async function ImprintPage() {
  ...
  const sections = page?.sections?.length ? page.sections : [
    ...
    { heading: "Verbraucherstreitbeilegung", text: "Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen." },
